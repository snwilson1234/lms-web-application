...
class StudentCourses(models.Model):
    ...
    course_section           = models.ForeignKey(CourseSections, on_delete=models.CASCADE)
    course_title            = models.ForeignKey(Courses, on_delete=models.CASCADE, null=True, default="LINEAR CIRCUITS")
